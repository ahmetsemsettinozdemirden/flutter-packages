...
class CameraValue {
  ...
  CameraValue copyWith({
    ...
    return CameraValue(
      ...
      previewPauseOrientation: previewPauseOrientation == null ? this.previewPauseOrientation : previewPauseOrientation.orNull,
    );
  }
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> pausePreview() async {
    ...
    try {
      ...
      value = value.copyWith(
          isPreviewPaused: true, previewPauseOrientation: Optional<DeviceOrientation>.of(value.lockedCaptureOrientation ?? value.deviceOrientation));
    } on PlatformException catch (e) {
      throw CameraException(e.code, e.message);
    }
  }
  ...
  Future<void> setFocusDistance(double focusDistance) {
    _throwIfNotInitialized('setFocusDistance');
    try {
      return CameraPlatform.instance.setFocusDistance(_cameraId, focusDistance);
    } on PlatformException catch (e) {
      throw CameraException(e.code, e.message);
    }
  }
