...
class AndroidCamera extends CameraPlatform {
  ...
  Future<void> initializeCamera(
    ...
    _channels.putIfAbsent(cameraId, () {
      final MethodChannel channel = MethodChannel('plugins.flutter.io/camera_android/camera$cameraId');
  ...
  Future<dynamic> _handleDeviceMethodCall(MethodCall call) async {
    switch (call.method) {
      case 'orientation_changed':
        ...
        _deviceEventStreamController.add(DeviceOrientationChangedEvent(deserializeDeviceOrientation(arguments['orientation']! as String)));
      default:
